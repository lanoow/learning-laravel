<x-layout>
    ...
    <div class="px-8 md:px-80 flex flex-col">
        <span class="text-3xl font-black text-gray-900 pb-2 border-b-2 border-gray-300">Publish a New Post</span>

        <x-panel.nav>
            <x-error-alert />

            <form action="/panel/posts/create" method="POST" enctype="multipart/form-data" class="flex flex-col px-24 space-y-8">
                @csrf
